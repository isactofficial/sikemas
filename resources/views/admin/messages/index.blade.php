...
<head>
    ...
    <style>
        ...
        * , *::before, *::after{ box-sizing:border-box; }
        ...
        .skm-table td{ padding:14px 16px; border-bottom:1px solid #E5E7EB; font-size:13px; vertical-align: top; }
        .skm-table tbody tr:last-child td{ border-bottom:none; }
        .skm-table tbody tr:hover{ background:#F9FAFB; }

        /* Styling Khusus Pesan */
        .skm-sender-name { font-weight: 800; color: var(--skm-blue); display: block; }
        .skm-sender-email { color: #7aa4b9; font-size: 12px; }
        .skm-subject { font-weight: 700; color: #333; margin-bottom: 4px; display: block; }
        .skm-message-preview { color: #666; line-height: 1.4; font-size: 12px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
        ...
        /* === STYLE TOMBOL TOGGLE MOBILE === */
        .skm-mobile-toggle-btn {
        ...
        @media(max-width:767px){
            ...
            /* Class untuk membuka sidebar wrapper */
            #skmSidebarWrapper.is-open {
                left: 0;
            }
            ...
            .skm-controls-card { padding: 16px; }
            ...
            .skm-sender-name { font-size: 16px; }
            .skm-table td:nth-child(5) { position: absolute; top: 16px; right: 16px; width: auto !important; padding: 0; font-size: 11px; color: #999; background: #fff; }
            .skm-table td:nth-child(3), .skm-table td:nth-child(4) { padding: 8px 16px; }
            .skm-message-preview { -webkit-line-clamp: 3; margin-bottom: 8px; }
            .skm-table td:first-child { display: none; }
            .skm-table td:last-child { padding: 12px 16px; background: #F9FAFB; border-top: 1px solid #E5E7EB; margin-top: 8px; }
...
<body>
    ...
    <button class="skm-mobile-toggle-btn" id="skmMobileToggle">
                        ...
                        @forelse($messages as $index => $msg)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($msg->user_id)
                                        <div style="margin-top:4px;"><span style="background:#e0f2f1; color:#00695c; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:700;">Login User</span></div>
                                    @endif
                                </td>
                                <td>
                                    <span class="skm-subject">{{ $msg->subjek }}</span>
                                </td>
                                <td>
                                    <div class="skm-message-preview">
                                        {{ $msg->pesan }}
                                    </div>
                                </td>
                                <td>
                                    {{ $msg->created_at->format('d M Y') }}
                                    <div style="font-size:11px; color:#aaa;">{{ $msg->created_at->format('H:i') }}</div>
                                </td>
                                <td>
