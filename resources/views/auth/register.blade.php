...
<body>
    ...
    <div class="login-container">
        ...
        <h1 class="login-title">Daftar Akun Sikemas</h1>
        <p class="login-subtitle">Bergabunglah dengan kami dan mulai kembangkan ide kemasan brilian!</p>
        ...
        <button type="button" class="google-button" onclick="window.location.href='{{ url('/auth/google') }}'">
            <img src="{{ asset('assets/img/symbol21.svg') }}" alt="Google" class="google-icon">
            <span style="color: #555555;">Google</span>
        </button>
    ...
    <script>
        ...
        document.getElementById('registerForm').addEventListener('submit', function(e) {
            ...
            if (!minLength || !hasLetter || !hasNumber) {
                e.preventDefault();
                alert('Password harus minimal 8 karakter dan mengandung huruf serta angka');
                return false;
            }
        });
    </script>
