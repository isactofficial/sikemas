...
<body>
    ...
    <header class="skm-hero" role="banner">
        <div class="skm-hero-wrap">
            <div class="skm-hero-media" data-aos="fade-left" data-aos-duration="1000">
                <img src="{{ asset('assets/img/Berbagai_jenis_kemasan.png') }}" alt="Contoh kemasan karton"
                    loading="lazy">
            </div>
            <div class="skm-hero-copy" data-aos="fade-right" data-aos-duration="1000">
                <h1>Portofolio</h1>
        ...
        <style>
            .skm-hero {
                background: linear-gradient(90deg, #074159 0%, #1F6D72 55%, #28979e 100%);
                padding: 34px 16px 40px;
                margin-bottom: 34px;
                overflow: hidden;
            }

            /* Added overflow hidden to prevent scrollbar during animation */
            .skm-hero-wrap {
                max-width: 1100px;
                margin: 0 auto;
                display: grid;
    ...
    <section class="skm-results" aria-labelledby="results-title">
        <div class="skm-results-wrap">
            <h2 id="results-title" data-aos="fade-up">Hasil Kerja Kami</h2>

            <div class="skm-result-grid">
                <article class="skm-result-card" data-aos="fade-up" data-aos-delay="0">
                    <img src="{{ asset('assets/img/Container.png') }}" alt="Kotak kemasan khusus" loading="lazy">
                    <h3>Kotak Kemasan Khusus</h3>
                    <p>Pellentesque a imperdiet leo. Vivamus non augue vel justo commodo ornare. Ut a enim maximus,
                        congue lectus ut, tincidunt est. In laoreet vehicula tincidunt. Curabitur non facilisis quam.
                    </p>
                </article>
                <article class="skm-result-card" data-aos="fade-up" data-aos-delay="150">
                    <img src="{{ asset('assets/img/karton_buka.png') }}" alt="Karton Bergelombang" loading="lazy">
                    <h3>Karton Bergelombang</h3>
                    <p>Pellentesque a imperdiet leo. Vivamus non augue vel justo commodo ornare. Ut a enim maximus,
                        congue lectus ut, tincidunt est. In l.</p>
                </article>
                <article class="skm-result-card" data-aos="fade-up" data-aos-delay="300">
                    <img src="{{ asset('assets/img/karton_banyak.png') }}" alt="Kemasan massal beragam ukuran"
                        loading="lazy">
                    <h3>Kemasan Ramah Lingkungan</h3>
                    <p>Pellentesque a imperdiet leo. Vivamus non augue vel justo commodo ornare. Ut a enim maximus,
                        congue lectus ut, tincidunt est. In laoreet vehicula tincidunt. Curabitur non facilisis quam.
                        Aliquam gravida purus sed tellus pulvinar, eu accumsan orci tincidunt. Duis sagittis, diam
                        ultricies semper pharetra, metus sem mattis nulla.</p>
                </article>
            </div>
        </div>
        ...
        <style>
            ...
            .skm-result-card {
                background: #fff;
                border-radius: 12px;
                box-shadow: 0 8px 20px rgba(7, 65, 89, .08);
                padding: 14px;
                text-align: center
            }
            ...
            @media (max-width:900px) {
                ...
                .skm-result-card {
                    padding: 12px;
                    box-shadow: 0 6px 16px rgba(7, 65, 89, .07)
                }
    ...
    <section class="t-section" aria-labelledby="testimoni-title">
        <div class="t-wrap">
            <h2 id="testimoni-title" data-aos="fade-down">Testimoni</h2>

            @if (isset($testimonies) && $testimonies->count() > 0)
                <div class="t-carousel" data-count="{{ $testimonies->count() }}" data-aos="zoom-in"
            ...
            @else
                <p style="text-align:center; color:#355a68" data-aos="fade-up">Belum ada testimoni untuk ditampilkan.
                </p>
            @endif
        </div>
        ...
        <style>
            ...
            .t-section {
                ...
                --nav-size: 38px;
                --nav-gap: 10px;
                padding: 28px calc(12px + var(--nav-size) + var(--nav-gap))
            }
            ...
            .t-nav {
                ...
                box-shadow: 0 4px 14px rgba(7, 65, 89, .08);
                width: var(--nav-size);
                height: var(--nav-size);
                border-radius: 50%;
                display: grid;
            ...
            .t-prev {
                left: calc((var(--nav-size) + var(--nav-gap)) * -1)
            }

            .t-next {
                right: calc((var(--nav-size) + var(--nav-gap)) * -1)
            }
            ...
            @media (max-width:560px) {
                ...
                .t-section {
                    --nav-size: 34px;
                    --nav-gap: 8px;
                    padding: 22px calc(10px + var(--nav-size) + var(--nav-gap));
                }
            }
