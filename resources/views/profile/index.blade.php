...
<head>
    ...
    <style>
        ...
        * {
        ...
        .order-card.selesai {
            border-left-color: #074159;
        }

        .order-card.diproses {
            border-left-color: #23C8B8;
        }

        .order-card.dibatalkan {
...
<body>
    ...
    <div class="container" data-aos="fade-in" data-aos-duration="1000">
        <h1 class="page-title" data-aos="fade-down">Profile Pengguna</h1>
        ...
        <div class="profile-card" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="address-section">
                @forelse($addresses as $address)
                    <div class="address-card" data-aos="fade-left" data-aos-offset="100">
                        <div class="address-header">
                            <span class="address-type">
                                {{ $address->address_type }}
                            </span>
                            <div class="address-actions">
                                <a href="{{ route('profile.address.edit', $address->id) }}" class="btn-icon"
                                    title="Edit">
                                ...
                                <form id="delete-form-{{ $address->id }}"
                                    action="{{ route('profile.address.delete', $address->id) }}" method="POST"
                ...
                @empty
                    <p style="color: #666; text-align: center; padding: 2rem 0;" data-aos="fade-in">Belum ada alamat
                        tersimpan</p>
                @endforelse
            </div>

            <a href="{{ route('profile.address.create') }}" class="add-address-btn" data-aos="zoom-in">
        ...
        <div class="profile-card" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
                ...
                @if ($order->shipping_status === 'Arrived') selesai
            ...
            "
                        ...
                        <div class="order-header">
                            ...
                            <span
                                class="order-status
                        @if ($order->shipping_status === 'Arrived') status-selesai
                        @elseif($order->shipping_status === 'Shipped' || $order->shipping_status === 'Pending')
                            status-diproses
                        @else
                            status-dibatalkan @endif
                    ">
                        ...
                        <div class="order-actions">
                            ...
                            <a href="{{ route('invoice.show', $order->id) }}?download=true" class="order-btn"
                                target="_blank">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                                    <path fill-rule="evenodd"
                ...
                @empty
                    <p style="color: #666; text-align: center; padding: 2rem 0;" data-aos="fade-in">Belum ada riwayat
                        pesanan</p>
                @endforelse
            </div>

            @if ($orders->hasPages())
                <div class="pagination-custom" data-aos="fade-up" data-aos-offset="50">
